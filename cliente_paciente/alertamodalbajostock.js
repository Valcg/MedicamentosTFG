document.addEventListener("DOMContentLoaded", () => {
    ...
    function verificarMedicamentosCliente() {
        axios.get(`http://medicade-back.involux.es/pacientes/VerMisMedicamentos/paciente/${idPaciente}`)
            .then(response => {
    ...
    function verificarStockMedicamento(idMedicamento, esUltimo) {
        axios.post(`http://medicade-back.involux.es/pacientes/verificar-stock/${idPaciente}/${idMedicamento}`)
            .then(response => {
    ...
    window.confirmarAlertaBajoStock = function(idAlerta) {
        ...
        axios.post(`http://medicade-back.involux.es/pacientes/confirmarAlertaBajoStock/${idAlerta}`)
            .then(() => {
    ...
    window.posponerAlertaBajoStock = function(idAlerta) {
        ...
        axios.post(`http://medicade-back.involux.es/pacientes/posponerAlertaBajoStock/${idAlerta}`, {})
            .then(res => {
