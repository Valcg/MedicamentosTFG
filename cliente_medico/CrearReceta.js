document.addEventListener("DOMContentLoaded", function () {
    ...
    axios.get("https://medicade-back.involux.es/medicos/BuscarTodosLosMedicamentos")
        .then(response => {
            ...
            axios.get(`https://medicade-back.involux.es/medicos/VerMisPacientes/${numeroColegiado}`)
                .then(resp => {
    ...
    function validarCorreoPaciente(correo) {
        ...
        axios.get(`https://medicade-back.involux.es/medicos/buscarPorCorreo?correo=${correo}`)
            .then(response => {
    ...
    function enviarReceta() {
        ...
        axios.get(`https://medicade-back.involux.es/medicos/buscarPorCorreo?correo=${correoPaciente}`)
            .then(response => {
                const paciente = response.data;
                ...
                axios.post("https://medicade-back.involux.es/medicos/CrearReceta", recetaDto)
                    .then(() => {
