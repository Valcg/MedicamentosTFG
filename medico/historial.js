document.addEventListener("DOMContentLoaded", function () {
    ...
    const idPaciente = localStorage.getItem("idPaciente"); // Obtener el idPaciente desde localStorage
    ...
    axios.get(url)
        .then(res => {
            ...
            if (!historial || historial.length === 0) {
                historialContainer.innerHTML = "<p>No hay historial de tomas disponible para este paciente.</p>";
            } else {
                ...
                historial.forEach(toma => {
                    ...
                    const nombrePaciente = toma.alerta && toma.alerta.paciente ? toma.alerta.paciente.nombrePaciente : 'No disponible';
